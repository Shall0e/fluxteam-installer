...
function neofetch {
    ...
    $neoversion = (Invoke-WebRequest -UserAgent "WEAO-3PService" -Method Get -Uri 'https://whatexpsare.online/api/versions/current' | ConvertFrom-Json).WindowsDate
    ...
    Write-HostCenter -ForegroundColor 'Yellow' -Message "@shall0e  :  Bootstrap Creator"
    Write-Host ' '

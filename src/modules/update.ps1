...
if ((Test-Path -Path (Join-Path $fluxPath "FluxTeam.exe")) -and (Test-Path -Path (Join-Path $fluxPath "main.exe")) -and (Test-Path -Path (Join-Path $fluxPath "FluxTeam.pdb")) -and (Test-Path -Path (Join-Path $fluxPath "FTbootstrapper.exe"))) {
